...
Name: Rijan Khatri
SID: @03086490
This is a Boggle solver that follows adjacency rules, uses "Qu" and "St" as
special tiles, and finds words in the grid based on a provided dictionary.
"""
...
def main():
    ...
    """
    # Example grid that should pass 'test_is_valid_grid'
    grid = [
        ['D', 'E', 'F'],
        ['E', 'A', 'B'],
        ['E', 'B', 'C'],
    ...
    # Example usage of boogle class
    dictionary = [
        'DEF', 'EAB', 'EBC', 'ECB', 'EDB', 'EFB', 'EGH', 'EHI', 'EIH'
    ]
